        ...
        <div className={"h-screen w-screen flex justify-center items-center bg-blue-100"}>
            <GoogleOAuthProvider clientId="311724826104-v19b2fi0tu7nc0i6j7inaoaqqrj5tpts.apps.googleusercontent.com">
                <div className="register-container">
                    ...
                    />
                    {nameError &&
                        <div className="error-message" style={{color: "red", textAlign: "left"}}>{nameError}</div>}
                    ...
                    <Input.Password
                        ...
                        className="input-field"
                    />
                    {confirmPasswordError && <div className="error-message" style={{
                        color: "red",
                        textAlign: "left"
                    }}>{confirmPasswordError}</div>}

                    <Button type="primary" block onClick={handleRegister} className="register-btn mb-3 rounded-xl">
                        Đăng ký
                    </Button>
                    ...
                    <GoogleLogin
                        ...
                        containerProps={{
                            ...
                            className: 'google-login-container mt-3 rounded-xl'
                        }}
                    />

                    <div className="footer">
                        <span className={"text-base italic"}>Đã có tài khoản? <a
                            className={"ms-2 font-semibold not-italic no-underline hover:font-bold"} href="/login">Đăng nhập</a></span>
                    </div>
